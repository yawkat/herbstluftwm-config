...
# make panels
command_singleton("panel", ("java", "-Xmx100M", "-Djava.library.path=classes/lib/x86_64/linux", "-Dcom.lambdaworks.jni.loader=sys", "-XX:+PrintGC", "-XX:+PrintGCDateStamps", "-XX:+UseSerialGC", "-cp", "classes", "at.yawk.wm.Main"))
