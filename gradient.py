...
fr = colorsys.rgb_to_hsv(0xdc * f, 0x32 * f, 0x2f * f) # red
to = colorsys.rgb_to_hsv(0x85 * f, 0x99 * f, 0x00 * f) # green

off = to[0] - fr[0], to[1] - fr[1], to[2] - fr[2]

# get a color somewhere between red and green for the given fraction, red being 0 and green being 1
